...
- **Current version: v11** (`v11-2026-09-23-team-resolution`) - v10 plus the team on the Company page and every
  object rendered at full device resolution. Built and verified 2026-09-23; **not yet deployed** - drop this
  folder (or `OpenEXA-v11-team-resolution.zip`) on Netlify and record the site name in `_manifests/v11.json`.
- **Latest deployed: v10** (`v10-2026-09-21-research-company`) - live at <https://silly-gelato-17a75a.netlify.app/>;
  that folder is the exact uploaded source and was verified identical to the live site. v9 (`willowy-squirrel`,
  the CEO's cut) and v8 (`heartfelt-valkyrie`) remain online.
...
pages apart from Netlify's link rewriting); v11 is built and awaiting upload.
